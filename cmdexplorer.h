...
//rootname is stored at begiing in global that is used to convert all the path to absolute path;
...
//for copy permission of source and destination files
